...
export const AppLogo: React.FC<{ className?: string; iconOnly?: boolean }> = ({ className, iconOnly = false }) => (
  <div className={cn("flex items-center gap-2.5", className)}>
    <div className="h-16 w-16 rounded-full overflow-hidden border border-navigation bg-transparent flex items-center justify-center flex-shrink-0 animate-[pulse_4s_ease-in-out_infinite] shadow-inner">
      <img
