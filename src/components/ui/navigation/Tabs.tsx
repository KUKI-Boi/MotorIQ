...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-xl bg-navigation/50 p-1 text-text-secondary border border-navigation overflow-x-auto no-scrollbar",
      className
    )}
    {...props}
  />
