...
const AdvancedChart = React.memo(({ data, dataKey, stroke, fill, yAxisDomain, title, icon: Icon }: { data: any[], dataKey: string, stroke: string, fill?: string, yAxisDomain?: [number|string, number|string], title: string, icon: any }) => (
  <ChartCard className="h-[300px] lg:h-full flex flex-col min-h-0 p-3 md:p-4">
...
export default function Analytics() {
  ...
  return (
    <div className="flex-1 min-h-0 w-full flex flex-col gap-3 p-3 md:p-4 overflow-y-auto lg:overflow-hidden">
      {/* Top Header Controls */}
      ...
      {/* Main Charts Area */}
      <div className="flex-none lg:flex-1 min-h-0 flex flex-col gap-3">
        {/* ROW 1: 3 Charts */}
        <div className="flex-none lg:flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-3 gap-3">
        ...
        {/* ROW 2: 2 Charts */}
        <div className="flex-none lg:flex-1 min-h-0 grid grid-cols-1 lg:grid-cols-2 gap-3">
